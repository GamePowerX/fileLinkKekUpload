...
let withFileName = document.getElementById("uploadWithFileName") as HTMLInputElement;
...
if(typeof accountId === "string" && accountId) {
    ...
    button.onclick = async () => {
        instanceUrl.disabled = withFileName.disabled = chunkSize.disabled = button.disabled = true;
        let start = Date.now();
