  ...
  upload(chunk: ArrayBuffer): Promise<string> {
    return new Promise(async (resolve, reject) => {
      if (this.stream === undefined)
        reject("Stream not initialized. Have you ran 'begin' yet?");
...
export class FileUploader extends ChunkedUploader {
  ...
  cancel(): Promise<void> {
    return new Promise((resolve, reject) => {
      if (!this.uploading)
        reject("Not uploading. Have you ran 'upload_file' yet?");
...
export class ChunkedDownloader {
  ...
  async pull(size: number): Promise<ArrayBuffer> {
    ...
    if (this.id === undefined)
      throw "Id is undefined. Have you ran 'begin' yet?";
